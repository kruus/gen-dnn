...
void compute_ref1_fwd(const prb_t *p, dnn_mem_t &src_m,
...
void compute_ref1_bwd_d(const prb_t *p, dnn_mem_t &diff_src_m,
...
void compute_ref1_bwd_w(const prb_t *p, dnn_mem_t &src_m,
