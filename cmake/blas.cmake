...
if(NECVE AND NOT DNNL_BLAS_VENDOR STREQUAL "NONE") # expect "ANY"
    # find_package(BLAS REQUIRED is failing these days.  Hardwire things as per toolchain file
    ##
    ## XXX approach used for SX, perhaps removable for VE ?
    #message(STATUS "BLA_VENDOR = ${BLA_VENDOR}")
    #set(CMAKE_PREFIX_PATH "${VE_CBLAS_DIR};${CMAKE_PREFIX_PATH}")
...
# This way is OK if the blas libraries include the cblas API:
