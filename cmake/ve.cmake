...
function(NLC_PRELIM_SETTINGS)
    ...
    if(_prelim_INIT)
        if(NOT IS_DIRECTORY "${VE_CBLAS_INCLUDE_DIR}")
            ...
            message(STATUS "    1) NLC_HOME environment variable (set by sourcing nlcvars.sh, bashrc-ve etc)")
...
function(VE_NLC_SETUP)
    ...
    if(_nlc_SEQ)
        ...
        set(_ve_openmp_or_sequential "${_ve_openmp}")
    endif()
    if(_nlc_MPI)
        set(_ve_mpi "_mpi")
    else()
...
if(NOT DEFINED VE_ASL)
    set(VE_ASL 0)
endif()
if(NOT DEFINED VE_CBLAS)
    set(VE_CBLAS 1)
endif()
if(NOT DEFINED VE_HET)
    set(VE_HET 0)
endif()

# VE_NLC_SETUP should be callable again, by user, but IS NOT [TODO]
