...
# map DNNL_OK_ vars to 0 or 1 for dnnl_config.h
...
# double-check surprises wrt cmake eval of empty variables
message(STATUS "DNNL_OK_STATIC_THREAD_LOCAL_OBJECTS '${DNNL_USE_STATIC_THREAD_LOCAL_OBJECTS}'")
message(STATUS "DNNL_USE_STATIC_THREAD_LOCAL_OBJECTS ${DNNL_USE_STATIC_THREAD_LOCAL_OBJECTS}")
message(STATUS "DNNL_OK_VALUE_INITIALIZATION '${DNNL_OK_VALUE_INITIALIZATION}'")
message(STATUS "DNNL_BUG_VALUE_INITIALIZATION ${DNNL_BUG_VALUE_INITIALIZATION}")
