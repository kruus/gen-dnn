...
*******************************************************************************/
/** \brief
 * C++ version of jit_primitive_conf.
 * Removes the packed structs used only by jit sgemm.
 * FIXME src/cpu/ should do this split into any and jit stuff. */
#ifndef ANY_PRIMITIVE_CONF_HPP
#define ANY_PRIMITIVE_CONF_HPP
...
struct any_1x1_conv_conf_t {
    ...
    int reduce_dim, reduce_block, nb_reduce,
        nb_reduce_blocking, nb_reduce_blocking_max; // only for TARGET_JIT ?
