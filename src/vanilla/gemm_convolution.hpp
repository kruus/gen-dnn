...
#undef AND_NEED
        ...
        jit_gemm_conv_conf_t jcp_; // TARGET_VANILLA #define --> any_gemm_conv_conf_t
...
struct _gemm_convolution_bwd_weights_t: public cpu_primitive_t {
    ...
    _gemm_convolution_bwd_weights_t(const pd_t *pd, const input_vector &inputs,
        ...
        : cpu_primitive_t(&conf_, inputs, outputs), conf_(*pd)
#ifndef TARGET_VANILLA
        , sgemm_0(nullptr), sgemm_1(nullptr)
#endif
        , col_(nullptr)
