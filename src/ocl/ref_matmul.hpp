...
#ifndef OCL_REF_MATMUL_HPP
#define OCL_REF_MATMUL_HPP
...
//#define ZERO_MD memory_desc_t(dnnl_memory_desc_t DNNL_ZERO_MEMORY_DESC_T)
#define ZERO_MD dnnl::impl::types::zero_md() /* OK */
//#define ZERO_MD dnnl_memory_desc_t{} /*I believe this also forces init, even if POD type*/
        memory_desc_t a0_md_ = ZERO_MD;
        memory_desc_t b0_md_ = ZERO_MD;
        memory_desc_t c0_md_ = ZERO_MD;
        memory_desc_t scales_md_ = ZERO_MD;
#endif
        int eltwise_idx_ = -1;
    };
