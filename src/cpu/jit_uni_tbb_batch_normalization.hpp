...
#ifndef CPU_JIT_UNI_TBB_BATCH_NORMALIZATION_HPP
#define CPU_JIT_UNI_TBB_BATCH_NORMALIZATION_HPP
...
template <cpu_isa_t isa>
struct jit_uni_tbb_batch_normalization_fwd_t : public primitive_impl_t {
...
template <cpu_isa_t isa>
struct jit_uni_tbb_batch_normalization_bwd_t : public primitive_impl_t {
