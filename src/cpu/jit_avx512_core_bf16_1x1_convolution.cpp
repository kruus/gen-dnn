...
void jit_avx512_core_bf16_1x1_convolution_fwd_t<dst_type>::execute_forward(
    ...
    if (pd()->wants_padded_bias()) {
        ...
        utils::array_copy(padded_bias, bias, bia_dt_size * jcp.oc_without_padding);
        utils::array_set(padded_bias + bia_dt_size * jcp.oc_without_padding, 0.f,
                bia_dt_size * (jcp.oc - jcp.oc_without_padding));
        bias = padded_bias;
    }
...
template struct jit_avx512_core_bf16_1x1_convolution_bwd_data_t<data_type::bf16>;
...
template struct jit_avx512_core_bf16_1x1_convolution_bwd_weights_t<data_type::f32>;
template struct jit_avx512_core_bf16_1x1_convolution_bwd_weights_t<data_type::bf16>;
