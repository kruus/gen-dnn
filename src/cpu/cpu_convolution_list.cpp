...
#include "cpu/ref_fused_convolution.hpp" // Note: heavily jit-dependent ??
...
static const std::map<conv_impl_key_t, std::vector<pd_create_f>> impl_list_map {
    ...
    {{forward, f32, f32, f32}, {
        ...
        INSTANCE_ref(ref_convolution_fwd_t<f32>)
        INSTANCE_ref(ref_fused_convolution_fwd_t)
        nullptr
    }},
    {{forward, bf16, bf16, f32}, {
        ...
        INSTANCE_ref(gemm_bf16_convolution_fwd_t<f32>) // omit from ref?
        nullptr
    }},
    {{forward, bf16, bf16, bf16}, {
        ...
        INSTANCE(jit_avx512_core_bf16_convolution_fwd_t)
        INSTANCE_ref(gemm_bf16_convolution_fwd_t<bf16>) // omit from ref?
        INSTANCE_ref(ref_fused_convolution_fwd_t)
        nullptr
    }},
    // BWD_D fp
    {{backward_data, f32, f32, f32}, {
        ...
        INSTANCE_ref(gemm_convolution_bwd_data_t)
        INSTANCE_ref(ref_convolution_bwd_data_t<f32, f32, f32, f32>)
        nullptr
    }},
    {{backward_data, f32, bf16, bf16}, {
        ...
        INSTANCE_ref(gemm_bf16_convolution_bwd_data_t<f32>)
        nullptr
    }},
    {{backward_data, bf16, bf16, bf16}, {
        ...
        INSTANCE(jit_avx512_core_bf16_convolution_bwd_data_t)
        INSTANCE_ref(gemm_bf16_convolution_bwd_data_t<bf16>)
        nullptr
    }},
    // BWD_W fp
    {{backward_weights, f32, f32, f32}, {
        ...
        INSTANCE_ref(gemm_convolution_bwd_weights_t)
        INSTANCE_ref(ref_convolution_bwd_weights_t<f32, f32, f32, f32>)
        nullptr
    }},
    {{backward_weights, bf16, f32, bf16}, {
        ...
        INSTANCE_ref(gemm_bf16_convolution_bwd_weights_t<f32>)
        nullptr
    }},
    {{backward_weights, bf16, bf16, bf16}, {
        ...
        INSTANCE(jit_avx512_core_bf16_convolution_bwd_weights_t)
        INSTANCE_ref(gemm_bf16_convolution_bwd_weights_t<bf16>)
        nullptr
    }},
    // FWD int8 (src:s8)
    {{forward, s8, s8, f32}, {
        ...
        INSTANCE_ref(_gemm_x8s8s32x_convolution_fwd_t<s8, f32>)
        INSTANCE_ref(ref_convolution_fwd_t<s8, s8, f32, s32>)
        INSTANCE_ref(ref_fused_convolution_fwd_t)
        nullptr
    }},
    {{forward, s8, s8, s32}, {
        ...
        INSTANCE_ref(_gemm_x8s8s32x_convolution_fwd_t<s8, s32>)
        INSTANCE_ref(ref_convolution_fwd_t<s8, s8, s32, s32>)
        INSTANCE_ref(ref_fused_convolution_fwd_t)
        nullptr
    }},
    {{forward, s8, s8, s8}, {
        ...
        INSTANCE_ref(_gemm_x8s8s32x_convolution_fwd_t<s8, s8>)
        INSTANCE_ref(ref_convolution_fwd_t<s8, s8, s8, s32>)
        INSTANCE_ref(ref_fused_convolution_fwd_t)
        nullptr
    }},
    {{forward, s8, s8, u8}, {
        ...
        INSTANCE_ref(_gemm_x8s8s32x_convolution_fwd_t<s8, u8>)
        INSTANCE_ref(ref_convolution_fwd_t<s8, s8, u8, s32>)
        INSTANCE_ref(ref_fused_convolution_fwd_t)
        nullptr
    }},
    // FWD int8 (src:u8)
    {{forward, u8, s8, f32}, {
        ...
        INSTANCE_ref(_gemm_x8s8s32x_convolution_fwd_t<u8, f32>)
        INSTANCE_ref(ref_convolution_fwd_t<u8, s8, f32, s32>)
        nullptr
    }},
    {{forward, u8, s8, s32}, {
        ...
        INSTANCE_ref(_gemm_x8s8s32x_convolution_fwd_t<u8, s32>)
        INSTANCE_ref(ref_convolution_fwd_t<u8, s8, s32, s32>)
        nullptr
    }},
    {{forward, u8, s8, s8}, {
        ...
        INSTANCE_ref(_gemm_x8s8s32x_convolution_fwd_t<u8, s8>)
        INSTANCE_ref(ref_convolution_fwd_t<u8, s8, s8, s32>)
        INSTANCE_ref(ref_fused_convolution_fwd_t)
        nullptr
    }},
    {{forward, u8, s8, u8}, {
        ...
        INSTANCE_ref(_gemm_x8s8s32x_convolution_fwd_t<u8, u8>)
        INSTANCE_ref(ref_convolution_fwd_t<u8, s8, u8, s32>)
        INSTANCE_ref(ref_fused_convolution_fwd_t)
        nullptr
    }},
    ...
    {{backward_data, s32, s8, s8}, {
        INSTANCE_ref(ref_convolution_bwd_data_t<s32, s8, s8, s32>)
        nullptr,
    }},
    {{backward_data, s8, s8, s8}, {
        INSTANCE_ref(ref_convolution_bwd_data_t<s8, s8, s8, s32>)
        nullptr,
    }},
    {{backward_data, u8, s8, s8}, {
        INSTANCE_ref(ref_convolution_bwd_data_t<u8, s8, s8, s32>)
        nullptr,
    }},
};
// clang-format on
