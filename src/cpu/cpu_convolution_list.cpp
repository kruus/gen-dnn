...
static const std::map<conv_impl_key_t, std::vector<pd_create_f>> impl_list_map {
    ...
    {{forward, f32, f32, f32}, {
        ...
        INSTANCE(jit_avx2_convolution_fwd_t) // CHECKME here?
        INSTANCE(jit_sse41_convolution_fwd_t)
        INSTANCE_ref(gemm_convolution_fwd_t) // may or may not use jit or MKL or CBLAS
    ...
    {{forward, bf16, bf16, f32}, {
        ...
        INSTANCE_ref(gemm_bf16_convolution_fwd_t<f32>) // may or may not actually be supported
        nullptr,
    }},
    {{forward, bf16, bf16, bf16}, {
        ...
        INSTANCE(jit_avx512_core_bf16_convolution_fwd_t)
        INSTANCE_ref(gemm_bf16_convolution_fwd_t<bf16>)
        nullptr,
    }},
    // BWD_D fp
